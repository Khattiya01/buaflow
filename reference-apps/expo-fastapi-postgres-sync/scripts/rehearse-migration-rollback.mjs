...
// and that rolling forward again afterward recovers a working schema — same pattern as
// reference-apps/react-fastapi-postgres-crud/scripts/rehearse-migration-rollback.mjs.
// Run: node scripts/rehearse-migration-rollback.mjs
//
// This is destructive to whatever is in the target database — only ever point it at the
// local docker-compose Postgres, never a real one. Every step is logged and the full
// transcript is written to evidence/migration-rollback-rehearsal.json.
