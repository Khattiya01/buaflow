...
// primary flow works — all from a torn-down starting state, none of it reusing a warm cache or
// an already-running app process. Run: node scripts/rehearse-clean-environment.mjs
//
...
const IMAGE = "react-fastapi-postgres-crud:rehearsal";
const CONTAINER = "react-fastapi-postgres-crud-rehearsal";
const PORT = 8199;
const NETWORK = "react-fastapi-postgres-crud_default";
