...
// (content.json's profile decision — a public-facing surface commits to this budget;
// this app models the internal-crud profile but the check costs nothing to keep on).
