...
| EV-011 | เก็บข้อมูลการใช้งานภายใน (opt-in) | **in progress (D-028)** — ส่งใน kit 3.13.0: ยินยอมใน `/buaflow:start` · hook `usage-capture` · sync ไป private repo · `buaflow usage report/show/eval-draft` · เหลือใช้จริงใน 2 โปรเจกต์ภายใน (EV-011.9) · เปิดใหม่แทน EV-005 เพราะมีผู้ใช้จริงแล้ว (Bluepeak Hub + โปรเจกต์ภายใน 2–5 โปรเจกต์) · ถามยินยอมครั้งเดียวต่อโปรเจกต์ · เก็บ event ตาม lifecycle พร้อมชื่อ model และเนื้อหาเต็ม · รวมที่ private git repo · ใช้ทำ eval corpus, เทียบผลของ model, dashboard รวม และเคสอ้างอิง |
