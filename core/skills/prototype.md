...
argumentHint: [screen names to add, or empty to refresh]
claudeAllowedTools: ["Read","Glob","Grep","Write","Edit","Bash(node .claude/prototype.js*)","Bash(git log*)","Bash(git diff*)"]
---
