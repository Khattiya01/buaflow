...
# legacy-explorer — delegated role, done serially

> Reads a legacy project read-only and summarizes it as an inventory of pages, components, APIs, and business logic. Used during rebuilds so the main context does not fill with old code.
