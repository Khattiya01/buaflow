...
Read `docs/intents/<argument>*.md`. No intent → stop and send the user to `/intent` first.
...
`docs/templates/elaboration.tpl.md` → `docs/elaboration/<argument>-<slug>.md`.
