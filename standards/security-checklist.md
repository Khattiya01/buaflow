...
อิง OWASP Top 10 ปรับให้ใช้กับเว็บ TypeScript + Node + Prisma
...
## 4. Database
- [ ] ใช้ Prisma (parameterized) เป็นหลัก
- [ ] ถ้าใช้ `$queryRaw` ต้องใช้แบบ parameterized เท่านั้น และ **ต้องถูก review เป็นพิเศษ**
