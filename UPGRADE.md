...
> เวอร์ชันล่าสุด: **v3.18.0** · ไม่รู้ว่าโปรเจกต์ใช้รุ่นไหน → `node buaflow/bin/buaflow.js lock` (ถ้ามี `.buaflow/lock.json`)
...
|---|---|---|
| **v2.3.4 – v3.12.1** | [ทางลัด: ไป v3.18.0 ในรอบเดียว](#fast-path) | ~5 นาที + ขั้นที่ต้องลงมือถ้าเข้าเงื่อนไข |
| **v3.17.1** | [v3.17.1 → v3.18.0](#v3171--v3180-minor--อัปเดต-plugin-จบ) ข้างล่างนี้ | 0 นาที |
...
## ทางลัด: จาก v2.3.4 หรือ 3.x รุ่นไหนก็ได้ → v3.18.0 ในรอบเดียว
